...
exports.verifyJWTsAndRegenerate = exports.verifyJWT = exports.provideTokens = void 0;
...
const verifyJWTsAndRegenerate = (currentRefreshJWT) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const payload = yield verifyRefreshJWT(currentRefreshJWT);
...
exports.verifyJWTsAndRegenerate = verifyJWTsAndRegenerate;
